...
# virtual methods
.method public a(Lb/a/cY;Lb/a/aa;)V
    .locals 5
    ...
    iput-object v0, p2, Lb/a/aa;->a:Ljava/lang/String;

    invoke-virtual {p2, v3}, Lb/a/aa;->a(Z)V
    ...
    invoke-virtual {p2, v3}, Lb/a/aa;->b(Z)V
    ...
    iput-object v0, p2, Lb/a/aa;->c:Ljava/lang/String;

    invoke-virtual {p2, v3}, Lb/a/aa;->c(Z)V
    ...
    iput-wide v0, p2, Lb/a/aa;->d:J

    invoke-virtual {p2, v3}, Lb/a/aa;->d(Z)V
...
.method public bridge synthetic a(Lb/a/cY;Lb/a/cq;)V
    ...
    invoke-virtual {p0, p1, p2}, Lb/a/ab;->a(Lb/a/cY;Lb/a/aa;)V

    return-void
.end method

.method public b(Lb/a/cY;Lb/a/aa;)V
    .locals 2

    invoke-virtual {p2}, Lb/a/aa;->p()V

    invoke-static {}, Lb/a/aa;->q()Lb/a/de;

    move-result-object v0

    invoke-virtual {p1, v0}, Lb/a/cY;->a(Lb/a/de;)V

    iget-object v0, p2, Lb/a/aa;->a:Ljava/lang/String;

    if-eqz v0, :cond_0

    invoke-static {}, Lb/a/aa;->r()Lb/a/cT;
    ...
    invoke-virtual {p2}, Lb/a/aa;->i()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {}, Lb/a/aa;->s()Lb/a/cT;
    ...
    :cond_1
    iget-object v0, p2, Lb/a/aa;->c:Ljava/lang/String;

    if-eqz v0, :cond_2

    invoke-static {}, Lb/a/aa;->t()Lb/a/cT;
    ...
    :cond_2
    invoke-static {}, Lb/a/aa;->u()Lb/a/cT;

    move-result-object v0

    invoke-virtual {p1, v0}, Lb/a/cY;->a(Lb/a/cT;)V

    iget-wide v0, p2, Lb/a/aa;->d:J
...
.method public bridge synthetic b(Lb/a/cY;Lb/a/cq;)V
    ...
    invoke-virtual {p0, p1, p2}, Lb/a/ab;->b(Lb/a/cY;Lb/a/aa;)V
