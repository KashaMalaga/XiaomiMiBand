...
.field final synthetic e:Landroid/support/v4/h/n;

.field final synthetic f:I

.field final synthetic g:Landroid/support/v4/h/i;

.field private h:Landroid/print/PrintAttributes;


# direct methods
.method constructor <init>(Landroid/support/v4/h/i;Ljava/lang/String;Landroid/net/Uri;Landroid/support/v4/h/n;I)V
    .locals 1

    iput-object p1, p0, Landroid/support/v4/h/k;->g:Landroid/support/v4/h/i;

    iput-object p2, p0, Landroid/support/v4/h/k;->c:Ljava/lang/String;

    iput-object p3, p0, Landroid/support/v4/h/k;->d:Landroid/net/Uri;

    iput-object p4, p0, Landroid/support/v4/h/k;->e:Landroid/support/v4/h/n;

    iput p5, p0, Landroid/support/v4/h/k;->f:I

    invoke-direct {p0}, Landroid/print/PrintDocumentAdapter;-><init>()V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/h/k;->b:Landroid/graphics/Bitmap;
...
.method private a()V
    ...
    iget-object v0, p0, Landroid/support/v4/h/k;->g:Landroid/support/v4/h/i;

    invoke-static {v0}, Landroid/support/v4/h/i;->a(Landroid/support/v4/h/i;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/v4/h/i;->b:Landroid/graphics/BitmapFactory$Options;
    ...
    iput-object v2, v0, Landroid/support/v4/h/i;->b:Landroid/graphics/BitmapFactory$Options;
...
.method static synthetic a(Landroid/support/v4/h/k;)V
    .locals 0

    invoke-direct {p0}, Landroid/support/v4/h/k;->a()V
...
.method public onFinish()V
    ...
    iget-object v0, p0, Landroid/support/v4/h/k;->a:Landroid/os/AsyncTask;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/os/AsyncTask;->cancel(Z)Z

    iget-object v0, p0, Landroid/support/v4/h/k;->e:Landroid/support/v4/h/n;
...
.method public onLayout(Landroid/print/PrintAttributes;Landroid/print/PrintAttributes;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$LayoutResultCallback;Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, Landroid/support/v4/h/k;->h:Landroid/print/PrintAttributes;

    :goto_0
    return-void

    :cond_0
    iget-object v1, p0, Landroid/support/v4/h/k;->b:Landroid/graphics/Bitmap;

    if-eqz v1, :cond_2

    new-instance v1, Landroid/print/PrintDocumentInfo$Builder;

    iget-object v2, p0, Landroid/support/v4/h/k;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/h/l;-><init>(Landroid/support/v4/h/k;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/print/PrintAttributes;Landroid/print/PrintDocumentAdapter$LayoutResultCallback;)V

    iput-object v0, p0, Landroid/support/v4/h/k;->a:Landroid/os/AsyncTask;
...
.method public onWrite([Landroid/print/PageRange;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    iget-object v2, p0, Landroid/support/v4/h/k;->h:Landroid/print/PrintAttributes;
    ...
    iget-object v3, p0, Landroid/support/v4/h/k;->g:Landroid/support/v4/h/i;

    iget-object v4, p0, Landroid/support/v4/h/k;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v4}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroid/support/v4/h/k;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v5}, Landroid/graphics/Bitmap;->getHeight()I

    move-result v5

    iget v6, p0, Landroid/support/v4/h/k;->f:I
