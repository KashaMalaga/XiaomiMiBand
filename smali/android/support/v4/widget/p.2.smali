...
.method private a(Landroid/support/v4/view/a/o;Landroid/support/v4/view/a/o;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/p;->c:Landroid/graphics/Rect;
...
.method private a(Landroid/support/v4/view/a/o;Landroid/view/ViewGroup;)V
    .locals 4
    ...
    invoke-virtual {p1, v2}, Landroid/support/v4/view/a/o;->c(Landroid/view/View;)V
...
.method public a(Landroid/view/View;Landroid/support/v4/view/a/o;)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/az;->k(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    :cond_1
    invoke-direct {p0, p2, v1}, Landroid/support/v4/widget/p;->a(Landroid/support/v4/view/a/o;Landroid/support/v4/view/a/o;)V

    invoke-virtual {v1}, Landroid/support/v4/view/a/o;->x()V

    check-cast p1, Landroid/view/ViewGroup;

    invoke-direct {p0, p2, p1}, Landroid/support/v4/widget/p;->a(Landroid/support/v4/view/a/o;Landroid/view/ViewGroup;)V
...
.method public b(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/p;->b:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/p;->b:Landroid/support/v4/widget/DrawerLayout;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/DrawerLayout;->d(I)Ljava/lang/CharSequence;
