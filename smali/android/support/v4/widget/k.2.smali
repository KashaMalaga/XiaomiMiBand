...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/k;->a:Landroid/support/v4/widget/DrawerLayout;

    invoke-direct {p0}, Landroid/support/v4/widget/ah;-><init>()V

    new-instance v0, Landroid/support/v4/widget/l;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/l;-><init>(Landroid/support/v4/widget/k;)V

    iput-object v0, p0, Landroid/support/v4/widget/k;->d:Ljava/lang/Runnable;

    iput p2, p0, Landroid/support/v4/widget/k;->b:I

    return-void
.end method

.method static synthetic a(Landroid/support/v4/widget/k;)V
    .locals 0
...
.method private b()V
    ...
    iget v1, p0, Landroid/support/v4/widget/k;->b:I
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/widget/k;->a:Landroid/support/v4/widget/DrawerLayout;
...
.method private c()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/k;->c:Landroid/support/v4/widget/ae;

    invoke-virtual {v1}, Landroid/support/v4/widget/ae;->c()I
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/k;->a:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/k;->c:Landroid/support/v4/widget/ae;
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/k;->b()V
...
.method public a()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/k;->d:Ljava/lang/Runnable;
...
.method public a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/k;->c:Landroid/support/v4/widget/ae;

    invoke-virtual {v2}, Landroid/support/v4/widget/ae;->d()Landroid/view/View;
...
.method public a(Landroid/support/v4/widget/ae;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/k;->c:Landroid/support/v4/widget/ae;
