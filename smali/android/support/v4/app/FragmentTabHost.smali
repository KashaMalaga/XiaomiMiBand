...
.field private d:Landroid/support/v4/app/R;

.field private e:I

.field private f:Landroid/widget/TabHost$OnTabChangeListener;

.field private g:Landroid/support/v4/app/ai;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/aj;)Landroid/support/v4/app/aj;
    ...
    invoke-static {v0}, Landroid/support/v4/app/ai;->b(Landroid/support/v4/app/ai;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/ai;

    if-eq v0, v1, :cond_5

    if-nez p2, :cond_2

    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/R;
    ...
    invoke-static {v0}, Landroid/support/v4/app/ai;->a(Landroid/support/v4/app/ai;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/aj;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/aj;

    :cond_3
    if-eqz v1, :cond_4

    invoke-static {v1}, Landroid/support/v4/app/ai;->a(Landroid/support/v4/app/ai;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ai;->c(Landroid/support/v4/app/ai;)Ljava/lang/Class;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ai;->d(Landroid/support/v4/app/ai;)Landroid/os/Bundle;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/app/ai;->a(Landroid/support/v4/app/ai;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/ai;->b(Landroid/support/v4/app/ai;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p2, v0, v2, v3}, Landroid/support/v4/app/aj;->a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/aj;

    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/ai;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/aj;->e(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/aj;
...
# virtual methods
.method public a(Landroid/content/Context;Landroid/support/v4/app/R;)V
    .locals 0
    ...
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/R;
...
.method public a(Landroid/content/Context;Landroid/support/v4/app/R;I)V
    .locals 2
...
.method public a(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, v0, p2, p3}, Landroid/support/v4/app/ai;-><init>(Ljava/lang/String;Ljava/lang/Class;Landroid/os/Bundle;)V

    iget-boolean v2, p0, Landroid/support/v4/app/FragmentTabHost;->h:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/R;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/R;
    ...
    invoke-static {v0, v4}, Landroid/support/v4/app/ai;->a(Landroid/support/v4/app/ai;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/ai;
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/R;
