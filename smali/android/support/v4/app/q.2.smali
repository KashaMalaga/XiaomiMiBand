...
.field k:Landroid/support/v4/app/r;
...
.method public constructor <init>(Landroid/support/v4/app/F;)V
    ...
    iput v0, p0, Landroid/support/v4/app/q;->x:I

    iput-object p1, p0, Landroid/support/v4/app/q;->b:Landroid/support/v4/app/F;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/q;->b:Landroid/support/v4/app/F;

    iput-object v0, p2, Landroid/support/v4/app/Fragment;->L:Landroid/support/v4/app/F;
...
.method public a()I
    ...
    iget v0, p0, Landroid/support/v4/app/q;->x:I
...
.method a(Z)I
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/F;->a(Landroid/support/v4/app/q;)I
...
.method public a(II)Landroid/support/v4/app/T;
    ...
    invoke-virtual {p0, p1, p2, v0, v0}, Landroid/support/v4/app/q;->a(IIII)Landroid/support/v4/app/T;
...
.method public a(IIII)Landroid/support/v4/app/T;
    ...
    iput p2, p0, Landroid/support/v4/app/q;->o:I

    iput p3, p0, Landroid/support/v4/app/q;->p:I

    iput p4, p0, Landroid/support/v4/app/q;->q:I
...
.method public a(Ljava/lang/CharSequence;)Landroid/support/v4/app/T;
    ...
    iput v0, p0, Landroid/support/v4/app/q;->y:I

    iput-object p1, p0, Landroid/support/v4/app/q;->z:Ljava/lang/CharSequence;
...
.method public a(Ljava/lang/String;)Landroid/support/v4/app/T;
    ...
    iput-object p1, p0, Landroid/support/v4/app/q;->v:Ljava/lang/String;
...
.method a(Landroid/support/v4/app/r;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/q;->k:Landroid/support/v4/app/r;

    if-nez v0, :cond_0

    iput-object p1, p0, Landroid/support/v4/app/q;->l:Landroid/support/v4/app/r;

    iput-object p1, p0, Landroid/support/v4/app/q;->k:Landroid/support/v4/app/r;
    ...
    iput v0, p0, Landroid/support/v4/app/q;->m:I

    return-void

    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/q;->l:Landroid/support/v4/app/r;
...
.method public a(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    ...
    :cond_4
    iget v0, p0, Landroid/support/v4/app/q;->y:I

    if-nez v0, :cond_5

    iget-object v0, p0, Landroid/support/v4/app/q;->z:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v4/app/q;->B:Ljava/lang/CharSequence;
...
.method public b(I)Landroid/support/v4/app/T;
    ...
    iput p1, p0, Landroid/support/v4/app/q;->s:I
...
.method public b(ILandroid/support/v4/app/Fragment;)Landroid/support/v4/app/T;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/app/q;->b(ILandroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/T;
...
.method public b(Ljava/lang/CharSequence;)Landroid/support/v4/app/T;
    ...
    iput v0, p0, Landroid/support/v4/app/q;->A:I

    iput-object p1, p0, Landroid/support/v4/app/q;->B:Ljava/lang/CharSequence;
...
.method public b(Z)V
    ...
    :cond_0
    invoke-virtual {p0, v6}, Landroid/support/v4/app/q;->e(I)V
    ...
    iget v2, v3, Landroid/support/v4/app/r;->c:I
    ...
    iget v1, v3, Landroid/support/v4/app/r;->h:I

    iput v1, v0, Landroid/support/v4/app/Fragment;->Z:I

    iget-object v1, p0, Landroid/support/v4/app/q;->b:Landroid/support/v4/app/F;

    iget v4, p0, Landroid/support/v4/app/q;->r:I

    invoke-static {v4}, Landroid/support/v4/app/F;->d(I)I

    move-result v4

    iget v5, p0, Landroid/support/v4/app/q;->s:I

    invoke-virtual {v1, v0, v4, v5}, Landroid/support/v4/app/F;->a(Landroid/support/v4/app/Fragment;II)V

    :cond_1
    :goto_1
    iget-object v0, v3, Landroid/support/v4/app/r;->b:Landroid/support/v4/app/r;
    ...
    iget v4, v3, Landroid/support/v4/app/r;->g:I

    iput v4, v0, Landroid/support/v4/app/Fragment;->Z:I

    iget-object v4, p0, Landroid/support/v4/app/q;->b:Landroid/support/v4/app/F;
    ...
    iget v1, v3, Landroid/support/v4/app/r;->g:I
    ...
    iget v1, v1, Landroid/support/v4/app/F;->t:I

    iget v2, p0, Landroid/support/v4/app/q;->r:I

    invoke-static {v2}, Landroid/support/v4/app/F;->d(I)I

    move-result v2

    iget v3, p0, Landroid/support/v4/app/q;->s:I
    ...
    iget v1, p0, Landroid/support/v4/app/q;->x:I

    invoke-virtual {v0, v1}, Landroid/support/v4/app/F;->c(I)V

    iput v6, p0, Landroid/support/v4/app/q;->x:I
...
.method public c(I)Landroid/support/v4/app/T;
    ...
    iput p1, p0, Landroid/support/v4/app/q;->y:I

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/app/q;->z:Ljava/lang/CharSequence;
...
.method public d(I)Landroid/support/v4/app/T;
    ...
    iput p1, p0, Landroid/support/v4/app/q;->A:I

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v4/app/q;->B:Ljava/lang/CharSequence;
...
.method public d()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v4/app/F;->u:Landroid/support/v4/app/FragmentActivity;

    iget v1, p0, Landroid/support/v4/app/q;->y:I
...
.method e(I)V
    ...
    iget v3, v3, Landroid/support/v4/app/Fragment;->K:I
    ...
    iget v3, v0, Landroid/support/v4/app/Fragment;->K:I

    add-int/2addr v3, p1

    iput v3, v0, Landroid/support/v4/app/Fragment;->K:I
...
.method public run()V
    ...
    :cond_1
    invoke-virtual {p0, v8}, Landroid/support/v4/app/q;->e(I)V
    ...
    iget v2, v4, Landroid/support/v4/app/r;->c:I
    ...
    :pswitch_0
    iget-object v0, v4, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;

    iget v1, v4, Landroid/support/v4/app/r;->e:I
    ...
    :cond_2
    :goto_1
    iget-object v0, v4, Landroid/support/v4/app/r;->a:Landroid/support/v4/app/r;
    ...
    iget-object v1, v1, Landroid/support/v4/app/F;->m:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Landroid/support/v4/app/F;->m:Ljava/util/ArrayList;
    ...
    sget-boolean v5, Landroid/support/v4/app/F;->b:Z
    ...
    iget v6, v3, Landroid/support/v4/app/Fragment;->Q:I
    ...
    iput-object v3, v4, Landroid/support/v4/app/r;->d:Landroid/support/v4/app/Fragment;
    ...
    :cond_6
    iget-object v5, v4, Landroid/support/v4/app/r;->i:Ljava/util/ArrayList;
    ...
    iput-object v5, v4, Landroid/support/v4/app/r;->i:Ljava/util/ArrayList;
    ...
    iget v5, v4, Landroid/support/v4/app/r;->f:I

    iput v5, v0, Landroid/support/v4/app/Fragment;->Z:I

    iget-boolean v5, p0, Landroid/support/v4/app/q;->t:Z
    ...
    iput v5, v0, Landroid/support/v4/app/Fragment;->K:I
    ...
    iget v7, v0, Landroid/support/v4/app/Fragment;->K:I
    ...
    :cond_8
    iget-object v5, p0, Landroid/support/v4/app/q;->b:Landroid/support/v4/app/F;

    iget v6, p0, Landroid/support/v4/app/q;->r:I

    iget v7, p0, Landroid/support/v4/app/q;->s:I
    ...
    iput v0, v3, Landroid/support/v4/app/Fragment;->Z:I
    ...
    iget v1, v4, Landroid/support/v4/app/r;->f:I
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/F;->b(Landroid/support/v4/app/q;)V
...
.method public toString()Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/q;->v:Ljava/lang/String;
