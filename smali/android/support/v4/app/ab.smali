...
# interfaces
.implements Landroid/support/v4/content/u;
...
.field d:Landroid/support/v4/content/s;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Landroid/support/v4/app/aA;ILandroid/os/Bundle;Landroid/support/v4/app/az;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput-object p4, p0, Landroid/support/v4/app/aB;->c:Landroid/support/v4/app/az;
...
.method a()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/aB;->c:Landroid/support/v4/app/az;

    return-void
.end method

.method public a(Landroid/support/v4/content/s;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/aA;->c:Landroid/support/v4/l/v;

    iget v1, p0, Landroid/support/v4/app/aB;->a:I

    invoke-virtual {v0, v1}, Landroid/support/v4/l/v;->a(I)Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroid/support/v4/app/aA;->c:Landroid/support/v4/l/v;

    iget v2, p0, Landroid/support/v4/app/aB;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/l/v;->b(ILjava/lang/Object;)V

    invoke-virtual {p0}, Landroid/support/v4/app/aB;->d()V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/aB;->b(Landroid/support/v4/content/s;Ljava/lang/Object;)V

    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/aB;->o:Landroid/support/v4/app/aA;

    iget-object v0, v0, Landroid/support/v4/app/aA;->d:Landroid/support/v4/l/v;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/l/v;->c(I)V

    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/aB;->o:Landroid/support/v4/app/aA;

    iget-object v0, v0, Landroid/support/v4/app/aA;->f:Landroid/support/v4/app/FragmentActivity;
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/aB;->c:Landroid/support/v4/app/az;
    ...
    iget-object v0, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroid/support/v4/content/s;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method b()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/aB;->stop()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/aB;->b(Landroid/support/v4/content/s;Ljava/lang/Object;)V

    :cond_2
    return-void
.end method

.method b(Landroid/support/v4/content/s;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v1, Landroid/support/v4/app/aA;->f:Landroid/support/v4/app/FragmentActivity;
    ...
    iget-object v1, v1, Landroid/support/v4/app/FragmentActivity;->e:Landroid/support/v4/app/U;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/content/s;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/az;->a(Landroid/support/v4/content/s;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/aA;->f:Landroid/support/v4/app/FragmentActivity;
    ...
    iget-object v2, v2, Landroid/support/v4/app/FragmentActivity;->e:Landroid/support/v4/app/U;
...
.method d()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/aB;->c:Landroid/support/v4/app/az;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;
    ...
    iget-object v3, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;

    invoke-interface {v0, v3}, Landroid/support/v4/app/az;->a(Landroid/support/v4/content/s;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    iput-object v2, p0, Landroid/support/v4/app/aB;->c:Landroid/support/v4/app/az;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/content/s;->a(Landroid/support/v4/content/u;)V

    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;

    invoke-virtual {v0}, Landroid/support/v4/content/s;->z()V
...
.method start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/az;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/s;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;
    ...
    iget-object v2, p0, Landroid/support/v4/app/aB;->d:Landroid/support/v4/content/s;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/content/s;->a(ILandroid/support/v4/content/u;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/s;->u()V
...
.method stop()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/s;->w()V
