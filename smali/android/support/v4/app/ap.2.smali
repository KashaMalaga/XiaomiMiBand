...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;)V
    ...
    iput-object p4, p0, Landroid/support/v4/app/ap;->d:Ljava/util/ArrayList;

    iput-object p5, p0, Landroid/support/v4/app/ap;->e:Landroid/transition/Transition;

    iput-object p6, p0, Landroid/support/v4/app/ap;->f:Ljava/util/ArrayList;

    iput-object p7, p0, Landroid/support/v4/app/ap;->g:Landroid/transition/Transition;

    iput-object p8, p0, Landroid/support/v4/app/ap;->h:Ljava/util/ArrayList;

    iput-object p9, p0, Landroid/support/v4/app/ap;->i:Ljava/util/Map;

    iput-object p10, p0, Landroid/support/v4/app/ap;->j:Ljava/util/ArrayList;

    iput-object p11, p0, Landroid/support/v4/app/ap;->k:Landroid/transition/Transition;
...
.method public onPreDraw()Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/ap;->d:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/al;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/ap;->e:Landroid/transition/Transition;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/app/ap;->e:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/ap;->f:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/al;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/ap;->g:Landroid/transition/Transition;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/app/ap;->g:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/ap;->h:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/al;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ap;->i:Ljava/util/Map;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/ap;->j:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v4/app/ap;->k:Landroid/transition/Transition;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/ap;->k:Landroid/transition/Transition;
