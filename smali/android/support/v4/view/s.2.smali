...
.method static synthetic a(Landroid/support/v4/view/s;Z)Z
    ...
    iput-boolean p1, p0, Landroid/support/v4/view/s;->o:Z
...
.method static synthetic c(Landroid/support/v4/view/s;)V
    ...
    invoke-direct {p0}, Landroid/support/v4/view/s;->d()V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/view/s;->k:Landroid/os/Handler;
    ...
    iget-object v4, p0, Landroid/support/v4/view/s;->t:Landroid/view/MotionEvent;
    ...
    iput-boolean v8, p0, Landroid/support/v4/view/s;->u:Z
    ...
    iget-object v4, p0, Landroid/support/v4/view/s;->m:Landroid/view/GestureDetector$OnDoubleTapListener;
    ...
    iput-boolean v8, p0, Landroid/support/v4/view/s;->q:Z
    ...
    iget v4, p0, Landroid/support/v4/view/s;->w:F

    sub-float/2addr v4, v1

    iget-boolean v5, p0, Landroid/support/v4/view/s;->u:Z
    ...
    :cond_e
    iget-boolean v5, p0, Landroid/support/v4/view/s;->q:Z

    if-eqz v5, :cond_10

    iget v5, p0, Landroid/support/v4/view/s;->x:F

    sub-float v5, v2, v5

    float-to-int v5, v5

    iget v6, p0, Landroid/support/v4/view/s;->y:F
    ...
    iget-object v6, p0, Landroid/support/v4/view/s;->l:Landroid/view/GestureDetector$OnGestureListener;

    iget-object v7, p0, Landroid/support/v4/view/s;->s:Landroid/view/MotionEvent;
