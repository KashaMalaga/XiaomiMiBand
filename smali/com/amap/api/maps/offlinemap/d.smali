...
.method public a(I)V
    ...
    check-cast v0, Lcom/amap/api/maps/offlinemap/m;
    ...
    :try_start_0
    new-instance v2, Lcom/amap/api/maps/offlinemap/l;

    invoke-virtual {v0}, Lcom/amap/api/maps/offlinemap/m;->f()Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v4, v1, v5}, Lcom/amap/api/maps/offlinemap/l;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    new-instance v1, Lcom/amap/api/maps/offlinemap/k;

    sget-object v3, Lcom/amap/api/maps/offlinemap/d;->i:Landroid/content/Context;

    invoke-direct {v1, v2, p0, v0, v3}, Lcom/amap/api/maps/offlinemap/k;-><init>(Lcom/amap/api/maps/offlinemap/l;Lcom/amap/api/maps/offlinemap/d;Lcom/amap/api/maps/offlinemap/m;Landroid/content/Context;)V

    iput-object v1, p0, Lcom/amap/api/maps/offlinemap/d;->e:Lcom/amap/api/maps/offlinemap/k;
...
.method public a(Lcom/amap/api/maps/offlinemap/m;II)V
    ...
    invoke-virtual {p1}, Lcom/amap/api/maps/offlinemap/m;->k()V
...
.method public b()V
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/amap/api/maps/offlinemap/d;->b(Lcom/amap/api/maps/offlinemap/m;II)Landroid/os/Message;
...
.method public b(Lcom/amap/api/maps/offlinemap/m;)V
    ...
    invoke-virtual {p0, p1, v1, v5}, Lcom/amap/api/maps/offlinemap/d;->a(Lcom/amap/api/maps/offlinemap/m;II)V
    ...
    invoke-virtual {v0, v4}, Lcom/amap/api/maps/AMap;->setLoadOfflineData(Z)V
    ...
    sget-object v3, Lcom/amap/api/maps/offlinemap/d;->h:Ljava/lang/String;
    ...
    invoke-static {v0, v2, p1, p0}, Lcom/amap/api/maps/offlinemap/o;->a(Ljava/lang/String;Ljava/lang/String;Lcom/amap/api/maps/offlinemap/m;Lcom/amap/api/maps/offlinemap/d;)Z
    ...
    sget-object v4, Lcom/amap/api/maps/offlinemap/d;->h:Ljava/lang/String;
    ...
    invoke-virtual {p1, v3}, Lcom/amap/api/maps/offlinemap/m;->b(Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Lcom/amap/api/maps/offlinemap/d;->k:Lcom/amap/api/maps/AMap;

    if-eqz v2, :cond_2

    iget-object v2, p0, Lcom/amap/api/maps/offlinemap/d;->k:Lcom/amap/api/maps/AMap;

    invoke-virtual {v2, v1}, Lcom/amap/api/maps/AMap;->setLoadOfflineData(Z)V

    :cond_2
    if-eqz v0, :cond_3

    iput v6, p1, Lcom/amap/api/maps/offlinemap/m;->a:I

    invoke-virtual {p0, p1, v6, v5}, Lcom/amap/api/maps/offlinemap/d;->a(Lcom/amap/api/maps/offlinemap/m;II)V
    ...
    invoke-virtual {p0, p1, v0, v5}, Lcom/amap/api/maps/offlinemap/d;->a(Lcom/amap/api/maps/offlinemap/m;II)V
