...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/h;->b:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Landroid/os/Handler;

    invoke-direct {v0}, Landroid/os/Handler;-><init>()V

    iput-object v0, p0, Lcom/amap/api/mapcore/h;->f:Landroid/os/Handler;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/amap/api/mapcore/h;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lcom/amap/api/mapcore/v;)V
    ...
    iput-object p3, p0, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/v;

    return-void
.end method

.method static synthetic a(Lcom/amap/api/mapcore/h;)V
    .locals 0

    invoke-direct {p0}, Lcom/amap/api/mapcore/h;->h()V
...
.method private h()V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/mapcore/aa;
    ...
    iput-object v2, p0, Lcom/amap/api/mapcore/h;->c:Lcom/autonavi/amap/mapcore/IPoint;

    iget-object v2, p0, Lcom/amap/api/mapcore/h;->e:Landroid/graphics/Rect;
    ...
    :cond_3
    iget-object v2, p0, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/v;

    invoke-interface {v2}, Lcom/amap/api/mapcore/v;->k()V

    iput-object v0, p0, Lcom/amap/api/mapcore/h;->e:Landroid/graphics/Rect;
...
.method public a(Landroid/view/MotionEvent;)Lcom/amap/api/mapcore/aa;
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/amap/api/mapcore/h;->a(Landroid/graphics/Rect;II)Z
...
.method public a(Lcom/amap/api/mapcore/aa;)V
    ...
    invoke-virtual {p0, p1}, Lcom/amap/api/mapcore/h;->e(Lcom/amap/api/mapcore/aa;)V
...
.method a(Ljava/lang/Integer;)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public a(Ljavax/microedition/khronos/opengles/GL10;Z)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->f:Landroid/os/Handler;

    new-instance v1, Lcom/amap/api/mapcore/i;

    invoke-direct {v1, p0}, Lcom/amap/api/mapcore/i;-><init>(Lcom/amap/api/mapcore/h;)V
...
.method public b()V
    ...
    invoke-virtual {p0, v2}, Lcom/amap/api/mapcore/h;->a(Ljava/lang/Integer;)V
...
.method public b(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v4, v1, v5}, Lcom/amap/api/mapcore/h;->a(Landroid/graphics/Rect;II)Z
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/mapcore/aa;
...
.method public b(Lcom/amap/api/mapcore/aa;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/amap/api/mapcore/h;->a(Ljava/lang/Integer;)V
...
.method public c(Lcom/amap/api/mapcore/aa;)V
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/h;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/h;->b:Ljava/util/concurrent/CopyOnWriteArrayList;

    iget-object v3, p0, Lcom/amap/api/mapcore/h;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public d()Lcom/amap/api/mapcore/aa;
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/mapcore/aa;
...
.method public d(Lcom/amap/api/mapcore/aa;)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->c:Lcom/autonavi/amap/mapcore/IPoint;
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/h;->c:Lcom/autonavi/amap/mapcore/IPoint;
    ...
    iput-object v1, p0, Lcom/amap/api/mapcore/h;->c:Lcom/autonavi/amap/mapcore/IPoint;

    iput-object p1, p0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/mapcore/aa;

    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/v;

    iget-object v1, p0, Lcom/amap/api/mapcore/h;->d:Lcom/amap/api/mapcore/aa;
...
.method public e()V
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0}, Lcom/amap/api/mapcore/h;->b()V
    :try_end_1
...
.method public e(Lcom/amap/api/mapcore/aa;)V
    ...
    invoke-virtual {p0, p1}, Lcom/amap/api/mapcore/h;->f(Lcom/amap/api/mapcore/aa;)Z
...
.method public f()Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/v;

    invoke-interface {v3}, Lcom/amap/api/mapcore/v;->h()I

    move-result v3

    iget-object v4, p0, Lcom/amap/api/mapcore/h;->a:Lcom/amap/api/mapcore/v;
    ...
    invoke-virtual {p0, v8, v0, v1}, Lcom/amap/api/mapcore/h;->a(Landroid/graphics/Rect;II)Z
