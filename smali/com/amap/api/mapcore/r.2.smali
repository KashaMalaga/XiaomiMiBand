...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/amap/api/mapcore/r;->p:F
...
.method public constructor <init>(Lcom/amap/api/mapcore/v;)V
    ...
    iput v0, p0, Lcom/amap/api/mapcore/r;->b:F

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/amap/api/mapcore/r;->c:Z

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/amap/api/mapcore/r;->i:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput v1, p0, Lcom/amap/api/mapcore/r;->l:I

    iput v1, p0, Lcom/amap/api/mapcore/r;->m:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/amap/api/mapcore/r;->n:Lcom/amap/api/maps/model/LatLngBounds;

    iput-boolean v1, p0, Lcom/amap/api/mapcore/r;->o:Z

    iput-object p1, p0, Lcom/amap/api/mapcore/r;->a:Lcom/amap/api/mapcore/v;

    :try_start_0
    invoke-virtual {p0}, Lcom/amap/api/mapcore/r;->c()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/r;->d:Ljava/lang/String;
    :try_end_0
...
.method static a([Lcom/autonavi/amap/mapcore/FPoint;)[Lcom/autonavi/amap/mapcore/FPoint;
    ...
    sget v6, Lcom/amap/api/mapcore/r;->p:F
    ...
    sget v7, Lcom/amap/api/mapcore/r;->p:F
...
.method public a(F)V
    ...
    iput p1, p0, Lcom/amap/api/mapcore/r;->b:F

    iget-object v0, p0, Lcom/amap/api/mapcore/r;->a:Lcom/amap/api/mapcore/v;
...
.method public a(I)V
    ...
    iput p1, p0, Lcom/amap/api/mapcore/r;->f:I
...
.method public a(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/r;->h:Ljava/util/List;

    invoke-virtual {p0, p1}, Lcom/amap/api/mapcore/r;->b(Ljava/util/List;)V
...
.method public a(Ljavax/microedition/khronos/opengles/GL10;)V
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/r;->i:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_1
    iget-object v0, p0, Lcom/amap/api/mapcore/r;->j:Ljava/nio/FloatBuffer;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/amap/api/mapcore/r;->k:Ljava/nio/FloatBuffer;

    if-eqz v0, :cond_2

    iget v0, p0, Lcom/amap/api/mapcore/r;->l:I

    if-eqz v0, :cond_2

    iget v0, p0, Lcom/amap/api/mapcore/r;->m:I
    ...
    iget v1, p0, Lcom/amap/api/mapcore/r;->f:I

    iget v2, p0, Lcom/amap/api/mapcore/r;->g:I

    iget-object v3, p0, Lcom/amap/api/mapcore/r;->j:Ljava/nio/FloatBuffer;

    iget v4, p0, Lcom/amap/api/mapcore/r;->e:F

    iget-object v5, p0, Lcom/amap/api/mapcore/r;->k:Ljava/nio/FloatBuffer;

    iget v6, p0, Lcom/amap/api/mapcore/r;->l:I

    iget v7, p0, Lcom/amap/api/mapcore/r;->m:I

    move-object v0, p1

    invoke-static/range {v0 .. v7}, Lcom/amap/api/mapcore/aC;->a(Ljavax/microedition/khronos/opengles/GL10;IILjava/nio/FloatBuffer;FLjava/nio/FloatBuffer;II)V

    :cond_4
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/amap/api/mapcore/r;->o:Z
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Lcom/amap/api/mapcore/r;->c:Z
...
.method public a()Z
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/r;->n:Lcom/amap/api/maps/model/LatLngBounds;
    ...
    :cond_1
    iget-object v2, p0, Lcom/amap/api/mapcore/r;->a:Lcom/amap/api/mapcore/v;
    ...
    :cond_2
    iget-object v3, p0, Lcom/amap/api/mapcore/r;->n:Lcom/amap/api/maps/model/LatLngBounds;
...
.method public a(Lcom/amap/api/maps/model/LatLng;)Z
    ...
    invoke-virtual {p0}, Lcom/amap/api/mapcore/r;->l()Ljava/util/List;
...
.method public b(F)V
    ...
    iput p1, p0, Lcom/amap/api/mapcore/r;->e:F
...
.method public b(I)V
    ...
    iput p1, p0, Lcom/amap/api/mapcore/r;->g:I
...
.method b(Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/r;->i:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_4
    iput v9, p0, Lcom/amap/api/mapcore/r;->l:I

    iput v9, p0, Lcom/amap/api/mapcore/r;->m:I
...
.method public c()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/r;->d:Ljava/lang/String;
...
.method public d()F
    ...
    iget v0, p0, Lcom/amap/api/mapcore/r;->b:F
...
.method public e()Z
    ...
    iget-boolean v0, p0, Lcom/amap/api/mapcore/r;->c:Z
...
.method public g()V
    ...
    iput-boolean v2, p0, Lcom/amap/api/mapcore/r;->o:Z
    ...
    iget-object v6, p0, Lcom/amap/api/mapcore/r;->a:Lcom/amap/api/mapcore/v;
    ...
    :cond_0
    invoke-static {v3}, Lcom/amap/api/mapcore/r;->a([Lcom/autonavi/amap/mapcore/FPoint;)[Lcom/autonavi/amap/mapcore/FPoint;
    ...
    sget v0, Lcom/amap/api/mapcore/r;->p:F
    ...
    :cond_2
    sput v9, Lcom/amap/api/mapcore/r;->p:F
    ...
    iput v0, p0, Lcom/amap/api/mapcore/r;->m:I

    invoke-static {v4}, Lcom/amap/api/mapcore/util/w;->a([F)Ljava/nio/FloatBuffer;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/r;->j:Ljava/nio/FloatBuffer;

    invoke-static {v5}, Lcom/amap/api/mapcore/util/w;->a([F)Ljava/nio/FloatBuffer;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/r;->k:Ljava/nio/FloatBuffer;
...
.method public h()F
    ...
    iget v0, p0, Lcom/amap/api/mapcore/r;->e:F
...
.method public i()I
    ...
    iget v0, p0, Lcom/amap/api/mapcore/r;->f:I
...
.method public k()Z
    ...
    iget-boolean v0, p0, Lcom/amap/api/mapcore/r;->o:Z
...
.method public l()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/amap/api/mapcore/r;->h:Ljava/util/List;
...
.method public m()I
    ...
    iget v0, p0, Lcom/amap/api/mapcore/r;->g:I
