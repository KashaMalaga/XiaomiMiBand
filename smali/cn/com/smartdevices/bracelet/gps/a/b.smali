...
.method public static a(Landroid/content/Context;J)Lcn/com/smartdevices/bracelet/gps/services/t;
    ...
    invoke-static {v4, v2}, Lcn/com/smartdevices/bracelet/v;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
...
.method public static a(Landroid/content/Context;IIJI)Ljava/util/List;
    ...
    const-string v2, "range[1,12] and groupType is GROUP_TYPE_MONTH"
    ...
    invoke-static {v1, v2, v3}, Lcn/com/smartdevices/bracelet/gps/d/e;->a(JI)J

    move-result-wide p3

    :cond_2
    invoke-static/range {p3 .. p5}, Lcn/com/smartdevices/bracelet/gps/d/e;->a(JI)J
    ...
    const-string v1, "SELECT month, SUM(distance) AS sumdistance, SUM(usedtime) AS sumtime FROM trackinfoview WHERE type =? AND trackid >=? AND trackid <?  GROUP BY month ORDER BY month DESC"
    ...
    invoke-virtual {v9, v1, v5}, Landroid/database/sqlite/SQLiteDatabase;->rawQuery(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_0
...
.method public static a(Landroid/content/Context;IJILjava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1, v2}, Lcn/com/smartdevices/bracelet/gps/d/e;->a(JI)J
    ...
    invoke-static {p2, p3, v0}, Lcn/com/smartdevices/bracelet/gps/d/e;->a(JI)J
...
.method public static b(Landroid/content/Context;ILjava/util/List;)Ljava/util/List;
    ...
    const-string v2, "SELECT month, SUM(distance) AS sumdistance, SUM(usedtime) AS sumtime FROM trackinfoview WHERE type =? "
...
.method public static d(Landroid/content/Context;ILjava/util/List;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static f(Landroid/content/Context;J)Z
    ...
    :cond_2
    invoke-static {p0, p1, p2}, Lcn/com/smartdevices/bracelet/gps/a/b;->h(Landroid/content/Context;J)Z
