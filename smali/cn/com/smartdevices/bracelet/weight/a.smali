...
.method static synthetic a(Lcn/com/smartdevices/bracelet/weight/a;Ljava/util/List;)Z
    ...
    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/weight/a;->g(Ljava/util/List;)Z
...
.method private g(Ljava/util/List;)Z
    ...
    invoke-virtual {v7, v1}, Lcn/com/smartdevices/bracelet/weight/i;->b(I)Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {v7, v9}, Lcn/com/smartdevices/bracelet/weight/i;->a(Ljava/util/List;)Z
...
.method private j()Lcn/com/smartdevices/bracelet/weight/UserInfo;
    .locals 3
...
.method public a(I)Lcn/com/smartdevices/bracelet/weight/UserInfo;
    ...
    invoke-direct {p0}, Lcn/com/smartdevices/bracelet/weight/a;->j()Lcn/com/smartdevices/bracelet/weight/UserInfo;
...
.method public a(Lcn/com/smartdevices/bracelet/weight/UserInfo;)V
    ...
    invoke-direct {p0}, Lcn/com/smartdevices/bracelet/weight/a;->i()I
...
.method public a(Lcn/com/smartdevices/bracelet/weight/v;)Z
    ...
    invoke-direct {v4, p0, v0, p1}, Lcn/com/smartdevices/bracelet/weight/c;-><init>(Lcn/com/smartdevices/bracelet/weight/a;Lcn/com/smartdevices/bracelet/model/SyncResult;Lcn/com/smartdevices/bracelet/weight/v;)V

    invoke-static {v1, v2, v3, v4}, Lcn/com/smartdevices/bracelet/j/e;->a(Lcn/com/smartdevices/bracelet/model/LoginData;IZLcom/e/a/a/h;)V
...
.method public b(Lcn/com/smartdevices/bracelet/weight/v;)Z
    .locals 5

    const/4 v1, 0x1

    invoke-static {}, Lcn/com/smartdevices/bracelet/x;->af()Z
    ...
    invoke-direct {v0, p0, p1}, Lcn/com/smartdevices/bracelet/weight/e;-><init>(Lcn/com/smartdevices/bracelet/weight/a;Lcn/com/smartdevices/bracelet/weight/v;)V

    invoke-virtual {p0, v0}, Lcn/com/smartdevices/bracelet/weight/a;->a(Lcn/com/smartdevices/bracelet/weight/v;)Z
    ...
    invoke-interface {p1}, Lcn/com/smartdevices/bracelet/weight/v;->a()V
...
.method public e(Lcn/com/smartdevices/bracelet/weight/UserInfo;)Z
    .locals 4
    ...
    const-string v2, "Sync UserInfo To Server!!"
    ...
    :cond_0
    new-instance v2, Lcn/com/smartdevices/bracelet/model/SyncResult;

    invoke-direct {v2}, Lcn/com/smartdevices/bracelet/model/SyncResult;-><init>()V

    const/4 v1, 0x0

    iget-object v3, p1, Lcn/com/smartdevices/bracelet/weight/UserInfo;->avatarUrl:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcn/com/smartdevices/bracelet/weight/UserInfo;->avatarSource:[B
    ...
    new-instance v3, Lcn/com/smartdevices/bracelet/weight/b;

    invoke-direct {v3, p0, v2, v0, p1}, Lcn/com/smartdevices/bracelet/weight/b;-><init>(Lcn/com/smartdevices/bracelet/weight/a;Lcn/com/smartdevices/bracelet/model/SyncResult;ZLcn/com/smartdevices/bracelet/weight/UserInfo;)V

    invoke-static {v1, p1, v0, v3}, Lcn/com/smartdevices/bracelet/j/e;->a(Lcn/com/smartdevices/bracelet/model/LoginData;Lcn/com/smartdevices/bracelet/weight/UserInfo;ZLcom/e/a/a/h;)V

    iget-boolean v0, v2, Lcn/com/smartdevices/bracelet/model/SyncResult;->result:Z
...
.method public e(Ljava/util/List;)Z
    ...
    invoke-virtual {p0, v0}, Lcn/com/smartdevices/bracelet/weight/a;->e(Lcn/com/smartdevices/bracelet/weight/UserInfo;)Z
...
.method public f(Ljava/util/List;)Z
    ...
    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/weight/a;->h(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-direct {v3, p0, v0, p1}, Lcn/com/smartdevices/bracelet/weight/d;-><init>(Lcn/com/smartdevices/bracelet/weight/a;Lcn/com/smartdevices/bracelet/model/SyncResult;Ljava/util/List;)V

    invoke-static {v2, v1, v3}, Lcn/com/smartdevices/bracelet/j/e;->c(Lcn/com/smartdevices/bracelet/model/LoginData;Ljava/lang/String;Lcom/e/a/a/h;)V
...
.method public h()Z
    ...
    invoke-virtual {p0, v1}, Lcn/com/smartdevices/bracelet/weight/a;->e(Ljava/util/List;)Z
    ...
    invoke-virtual {p0, v1}, Lcn/com/smartdevices/bracelet/weight/a;->f(Ljava/util/List;)Z
