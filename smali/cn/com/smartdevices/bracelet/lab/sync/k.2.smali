...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {p0, v2}, Lcn/com/smartdevices/bracelet/lab/sync/k;->a(Landroid/content/Context;I)Z

    new-instance v0, Lcn/com/smartdevices/bracelet/w;

    invoke-direct {v0, v2}, Lcn/com/smartdevices/bracelet/w;-><init>(I)V
    ...
    invoke-static {p0, v1}, Lcn/com/smartdevices/bracelet/lab/sync/k;->a(Landroid/content/Context;I)Z
...
.method static a(Landroid/content/Context;I)Z
    ...
    :cond_0
    new-instance v0, Lcn/com/smartdevices/bracelet/lab/sync/n;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcn/com/smartdevices/bracelet/lab/sync/n;-><init>(Lcn/com/smartdevices/bracelet/lab/sync/l;)V
    ...
    iput v2, v1, Lcn/com/smartdevices/bracelet/k/f;->b:I
    ...
    invoke-direct {v3, p1, v0, p0}, Lcn/com/smartdevices/bracelet/lab/sync/m;-><init>(ILcn/com/smartdevices/bracelet/lab/sync/n;Landroid/content/Context;)V
    ...
    iget-boolean v0, v0, Lcn/com/smartdevices/bracelet/lab/sync/n;->a:Z

    goto :goto_0
.end method

.method static a(Landroid/content/Context;Lcn/com/smartdevices/bracelet/w;)Z
    .locals 10
    ...
    invoke-virtual {v4, p1}, Lcn/com/smartdevices/bracelet/s;->a(Lcn/com/smartdevices/bracelet/w;)Ljava/util/ArrayList;
    ...
    :cond_1
    new-instance v1, Lcn/com/smartdevices/bracelet/lab/sync/n;

    invoke-direct {v1, v9}, Lcn/com/smartdevices/bracelet/lab/sync/n;-><init>(Lcn/com/smartdevices/bracelet/lab/sync/l;)V
    ...
    new-instance v0, Lcn/com/smartdevices/bracelet/lab/sync/l;

    move-object v2, p0

    move-object v3, p1

    invoke-direct/range {v0 .. v5}, Lcn/com/smartdevices/bracelet/lab/sync/l;-><init>(Lcn/com/smartdevices/bracelet/lab/sync/n;Landroid/content/Context;Lcn/com/smartdevices/bracelet/w;Lcn/com/smartdevices/bracelet/s;Ljava/util/ArrayList;)V
    ...
    iget-boolean v0, v1, Lcn/com/smartdevices/bracelet/lab/sync/n;->a:Z
