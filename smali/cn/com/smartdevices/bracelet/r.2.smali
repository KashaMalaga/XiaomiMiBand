...
.field private static final c:I = 0x276

.field private static final e:I = 0x12c

.field private static f:Lcn/com/smartdevices/bracelet/r;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/com/smartdevices/bracelet/r;->f:Lcn/com/smartdevices/bracelet/r;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcn/com/smartdevices/bracelet/r;->d:Ljava/lang/String;

    return-void
.end method

.method public static a()Lcn/com/smartdevices/bracelet/r;
    .locals 1

    sget-object v0, Lcn/com/smartdevices/bracelet/r;->f:Lcn/com/smartdevices/bracelet/r;

    if-nez v0, :cond_0

    new-instance v0, Lcn/com/smartdevices/bracelet/r;

    invoke-direct {v0}, Lcn/com/smartdevices/bracelet/r;-><init>()V
...
.method private a(Landroid/content/Context;II)V
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/aT;-><init>(Landroid/content/Context;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p1}, Landroid/support/v4/app/aT;-><init>(Landroid/content/Context;)V

    const v3, 0x7f020006

    invoke-virtual {v2, v3}, Landroid/support/v4/app/aT;->a(I)Landroid/support/v4/app/aT;

    move-result-object v2

    invoke-virtual {v2, p2}, Landroid/support/v4/app/aT;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/aT;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/aT;->e(Z)Landroid/support/v4/app/aT;
    ...
    const-class v3, Lcn/com/smartdevices/bracelet/ui/DailySleepReportActivity;
...
.method private b(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v1}, Lcn/com/smartdevices/bracelet/l;->e()Lcn/com/smartdevices/bracelet/model/ReportData;
...
.method private c(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v1}, Lcn/com/smartdevices/bracelet/l;->f()Lcn/com/smartdevices/bracelet/model/ReportData;
...
.method private d(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v1}, Lcn/com/smartdevices/bracelet/l;->h()Lcn/com/smartdevices/bracelet/model/ReportData;
...
.method private e(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Lcn/com/smartdevices/bracelet/l;->j()Lcom/xiaomi/hm/health/dataprocess/SportDay;

    move-result-object v3

    new-instance v4, Lcom/xiaomi/hm/health/dataprocess/SportDay;

    invoke-direct {v4}, Lcom/xiaomi/hm/health/dataprocess/SportDay;-><init>()V

    const/4 v5, -0x7

    invoke-virtual {v4, v5}, Lcom/xiaomi/hm/health/dataprocess/SportDay;->addDay(I)Lcom/xiaomi/hm/health/dataprocess/SportDay;

    move-result-object v4

    invoke-virtual {v4, v3}, Lcom/xiaomi/hm/health/dataprocess/SportDay;->compare(Lcom/xiaomi/hm/health/dataprocess/SportDay;)I
    ...
    invoke-virtual {v3}, Lcn/com/smartdevices/bracelet/l;->g()Lcn/com/smartdevices/bracelet/model/ReportData;
    ...
    invoke-virtual {v3, v0}, Lcn/com/smartdevices/bracelet/model/ReportData;->setStepsInfo(Lcom/xiaomi/hm/health/dataprocess/StepsInfo;)V
...
.method private f(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v0}, Lcn/com/smartdevices/bracelet/lua/LuaEvent;->setSleep(Lcom/xiaomi/hm/health/dataprocess/SleepInfo;)V
...
.method private g(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lcom/xiaomi/hm/health/dataprocess/StepsInfo;->getActiveList()Ljava/util/ArrayList;
    ...
    iget v3, v0, Lcom/xiaomi/hm/health/dataprocess/ActiveItem;->flag:I

    if-nez v3, :cond_2

    invoke-virtual {v1, v0}, Lcn/com/smartdevices/bracelet/lua/LuaEvent;->setActivities(Lcom/xiaomi/hm/health/dataprocess/ActiveItem;)V
...
.method private h(Landroid/content/Context;)V
    ...
    invoke-static {}, Lcom/xiaomi/hm/health/dataprocess/StepsInfo;->getRealtimeSteps()I
    ...
    invoke-static {}, Lcn/com/smartdevices/bracelet/Keeper;->readDailySportReport()Ljava/lang/String;
    ...
    :cond_3
    invoke-direct {p0, p1, v0, v6}, Lcn/com/smartdevices/bracelet/r;->a(Landroid/content/Context;II)V
    ...
    invoke-static {v0}, Lcn/com/smartdevices/bracelet/Keeper;->keepDailySportReport(Ljava/lang/String;)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->i(Landroid/content/Context;)V
    ...
    :cond_7
    invoke-virtual {p0, p1}, Lcn/com/smartdevices/bracelet/r;->c(Landroid/content/Context;)V
...
.method private i(Landroid/content/Context;)V
    ...
    sget-object v4, Lcn/com/smartdevices/bracelet/g;->aW:Ljava/lang/String;
...
.method private j(Landroid/content/Context;)V
    ...
    invoke-virtual {v2}, Lcom/xiaomi/hm/health/dataprocess/SleepInfo;->getStopDate()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lcn/com/smartdevices/bracelet/l;->q()I
    ...
    invoke-virtual {v0}, Lcn/com/smartdevices/bracelet/model/MiliConfig;->getDailySleepNofity()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {}, Lcn/com/smartdevices/bracelet/Keeper;->readLastNotifySleepDate()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcn/com/smartdevices/bracelet/Keeper;->setLastNotifySleepDate(Ljava/lang/String;)V

    invoke-virtual {v2}, Lcom/xiaomi/hm/health/dataprocess/SleepInfo;->getSleepCount()I

    move-result v0

    invoke-static {p1, v0}, Lcn/com/smartdevices/bracelet/g/f;->a(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcn/com/smartdevices/bracelet/r;->a(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_0

    :cond_4
    invoke-virtual {p0, p1}, Lcn/com/smartdevices/bracelet/r;->d(Landroid/content/Context;)V
...
.method public a(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->h(Landroid/content/Context;)V

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0}, Lcn/com/smartdevices/bracelet/r;->d(Landroid/content/Context;Z)V
...
.method public a(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/r;->b(Landroid/content/Context;Z)V

    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/r;->c(Landroid/content/Context;Z)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->f(Landroid/content/Context;)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->h(Landroid/content/Context;)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->g(Landroid/content/Context;)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->e(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/r;->d(Landroid/content/Context;Z)V

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/r;->j(Landroid/content/Context;)V
