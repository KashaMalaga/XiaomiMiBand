...
.method static synthetic access$000(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;)Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;
    .locals 1

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/model/game/GameManager;->getGameBriefInfo(Landroid/content/Context;)Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;
...
.method static synthetic access$100(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/model/game/GameManager;->clearGameUI(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V

    return-void
.end method

.method static synthetic access$200(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0, p1}, Lcn/com/smartdevices/bracelet/model/game/GameManager;->getRegisterInfo(Landroid/content/Context;)V

    return-void
.end method

.method static synthetic access$300(Lcn/com/smartdevices/bracelet/model/game/GameManager;)Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;
    .locals 1
...
.method static synthetic access$400(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/model/game/GameManager;->showGameRecord(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V

    return-void
.end method

.method static synthetic access$500(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcn/com/smartdevices/bracelet/model/game/GameManager;->showBonusBanner(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V

    return-void
.end method

.method static synthetic access$600(Lcn/com/smartdevices/bracelet/model/game/GameManager;Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;[B)V
    .locals 0
...
.method private checkContinusReachGoal(Lcom/xiaomi/hm/health/dataprocess/SportDay;Lcom/xiaomi/hm/health/dataprocess/SportDay;)I
    ...
    invoke-virtual {v4, v3}, Lcn/com/smartdevices/bracelet/l;->b(Lcom/xiaomi/hm/health/dataprocess/SportDay;)Lcom/xiaomi/hm/health/dataprocess/DaySportData$Summary;
...
.method private clearGameUI(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 2
    ...
    invoke-virtual {v0, p2}, Lde/greenrobot/event/EventBus;->post(Ljava/lang/Object;)V

    return-void
.end method

.method private getGameBriefInfo(Landroid/content/Context;)Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;
    .locals 3
    ...
    invoke-static {p1, v0}, Lcn/com/smartdevices/bracelet/k/j;->a(Landroid/content/Context;Lcom/d/a/a/h;)V
...
.method private getRegisterInfo(Landroid/content/Context;)V
    .locals 1
    ...
    invoke-static {p1, v0}, Lcn/com/smartdevices/bracelet/k/j;->b(Landroid/content/Context;Lcom/d/a/a/h;)V
...
.method private showBonusBanner(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 7
    ...
    invoke-virtual {v2, p1}, Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;->getBonusUrl(Landroid/content/Context;)Ljava/lang/String;
...
.method private showGameRecord(Landroid/content/Context;Lcn/com/smartdevices/bracelet/eventbus/EventGameUpdate;)V
    .locals 9
    ...
    invoke-virtual {v0, v1}, Lcn/com/smartdevices/bracelet/l;->b(Lcom/xiaomi/hm/health/dataprocess/SportDay;)Lcom/xiaomi/hm/health/dataprocess/DaySportData$Summary;
    ...
    invoke-virtual {v2, p1}, Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;->getGamePlayingUrl(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1}, Lcn/com/smartdevices/bracelet/model/game/GameBriefInfo;->getGamePlayingUrl(Landroid/content/Context;)Ljava/lang/String;
...
# virtual methods
.method public processGameEvent(Landroid/content/Context;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-direct {v0, p0, v1}, Lcn/com/smartdevices/bracelet/model/game/GameManager$GameTask;-><init>(Lcn/com/smartdevices/bracelet/model/game/GameManager;Landroid/content/Context;)V
